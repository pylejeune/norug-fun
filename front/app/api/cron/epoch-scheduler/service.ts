 ...
 */
export async function createNewEpoch(program: any, connection: Connection, wallet: AnchorWallet, adminKeypair: Keypair): Promise<{success: boolean, errors: string[], signature?: string, message?: string, epochId?: string}> {
  const errors: string[] = [];
